...
func TestSomething(t *testing.T) {
	cases := []struct {
		...
		{name: "#3.2", inputs: []*Item{{"Elixir of the Mongoose", -1, 2}}, outputs: []*Item{{"Elixir of the Mongoose", -2, 0}}},
		...
		{name: "#8.2", inputs: []*Item{{"Backstage passes to a TAFKAL80ETC concert", 10, 48}}, outputs: []*Item{{"Backstage passes to a TAFKAL80ETC concert", 9, 50}}},
		{name: "#8.3", inputs: []*Item{{"Backstage passes to a TAFKAL80ETC concert", 5, 40}}, outputs: []*Item{{"Backstage passes to a TAFKAL80ETC concert", 4, 43}}},
		{name: "#8.3", inputs: []*Item{{"Backstage passes to a TAFKAL80ETC concert", 0, 40}}, outputs: []*Item{{"Backstage passes to a TAFKAL80ETC concert", -1, 0}}},
